...
exports.run = async (client, message, args) => {
 ...
 if(!message.member.roles.cache.has('781110749971873862')) return message.channel.send('Bu kodu kullanmak için yeterli yetkin yok!')
  
  let member = message.mentions.members.first();
  let isim = args[1]
  let yaş = args[2]
  let al = "781113333528789013"; ///alınacak rol idsi
  let ver = "781111528635105281"; ///verilecek rol idsi
